...
<nav class="cp-navbar">
    ...
    <div class="cp-nav d-flex align-items-center gap-1">
        ...
        <a href="<?= BASE_URL ?>/client/service_history.php" class="<?= cpActive('service_history') ?>"><i class="fa fa-wrench me-1"></i>Service</a>
        <a href="<?= BASE_URL ?>/client/invoices.php"    class="<?= cpActive('invoices') ?>"><i class="fa fa-file-invoice me-1"></i>Invoices</a>
        <a href="<?= BASE_URL ?>/client/documents.php"   class="<?= cpActive('documents') ?>"><i class="fa fa-folder-open me-1"></i>Documents</a>
