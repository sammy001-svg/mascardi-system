...
if ($search) {
    $where[] = '(i.part_name LIKE ? OR i.part_number LIKE ? OR i.category LIKE ?)';
    $params[] = "%$search%";
    $params[] = "%$search%";
    $params[] = "%$search%";
}
    ...
    <div class="card-body py-2 px-3">
        <form method="GET" class="row g-2 align-items-end">
            <div class="col-12 col-md-5">
                <input type="text" name="q" class="form-control form-control-sm" placeholder="Search part name, number, category…" value="<?= e($search) ?>">
            </div>
            <div class="col-6 col-md-3">
            ...
            <div class="col-6 col-md-2">
                <select name="filter" class="form-select form-select-sm">
                    <option value="" <?= !$filter?'selected':'' ?>>All Stock</option>
        ...
        <table class="table table-hover datatable mb-0">
            ...
            <tbody>
                ...
                <tr><td colspan="11" class="text-center py-5 text-muted">
                    <i class="fa fa-boxes-stacked fa-2x mb-2 d-block"></i>No inventory items found.
                    <?php if (hasRole(['admin','manager'])): ?><br><a href="add.php" class="btn btn-sm btn-primary mt-2"><i class="fa fa-plus me-1"></i>Add First Part</a><?php endif; ?>
                </td></tr>
                <?php endif; ?>
            </tbody>
        </table>
